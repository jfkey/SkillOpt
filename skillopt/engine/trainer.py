...
class ReflACTTrainer:
    ...
    def train(self) -> dict:
        ...
        # ── Configure models ─────────────────────────────────────────────
        # Shared with the MCTS search runner so the two entry points cannot
        # drift apart (skillopt/engine/model_setup.py).
        backend, optimizer_backend, target_backend = configure_models_from_cfg(cfg)
